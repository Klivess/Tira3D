...
void Model::loadModel(std::string path)
{
	...
	{
		Tira3DLogging::LogToConsole("ERROR::ASSIMP:: " + std::string(importer.GetErrorString()));
		return;
	}
	// retrieve the directory path of the filepath
	directory = path.substr(0, path.find_last_of('/'));
	directory = directory.substr(0, directory.find_last_of(R"(\)"));
...
Mesh Model::processMesh(aiMesh* mesh, const aiScene* scene)
{
	...
	Mesh meshProcessed(vertices, indices, textures);
	Tira3DLogging::LogToConsole("ggg");
